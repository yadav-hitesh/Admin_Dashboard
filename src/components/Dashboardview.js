...
import { FaSearch, FaEnvelope, FaRegBell, FaList } from "react-icons/fa"
        ...
        <div className=''>
            <div className='flex items-center justify-between h-[70px] shadow-lg px-[25px] '>
                <div className='flex items-center rounded-[5px]'>
                    <FaList color='#5C588E'/>
                    <p className='text-[24px] text-[#5C588E] leading-[20px] font-bold'>&nbsp;&nbsp;Hello Mad✋</p>
                </div>
                <div className='flex items-center rounded-[5px]'>
                    ...
                    <div className='bg-[#5C588E] h-[40px] px-[14px] flex items-center justify-center cursor-pointer rounded-tr-[5px] rounded-br-[5px]'>
                ...
                <div className='flex items-center gap-[20px]'>
                    <div className='flex items-center gap-[25px] border-r-[1px] pr-[25px]'>
                        <FaRegBell color='#5C588E'/>
                        <FaEnvelope color='#5C588E'/>
                    </div>
                    <div className='flex items-center gap-[15px] relative' onClick={showProfile} >
                        <div>
                            <p className='text-[20px]'>Hitesh</p>
                            <p className='text-[13px] font-bold leading-[16px] text-black/[0.4]'>Designer</p>
                        </div> 
